...
```{r echo=FALSE}
census_api_key("61097d3589b9bdbb10ddc1e9e60ef1187f4b1c0f", install=TRUE, overwrite=TRUE)
...
**Answer** Nevada experienced the most growth of all US states, with a 35% increase in population from 2000 to 2010. 
...
**Answer** Howard County has the highest median household income of any county in Maryland. On average, the estimated annual household income in Howard County is approximately $129,500. 
...
**Answer** The headline could be changed to "Estimated annual household income by county in Maryland."
...
**Answer** Baltimore city had the largest increase in median income with a 37% jump from 2010 to 2021. Allegany County and Calvert County also experienced dramatic increases of 35 and 32 percent, respectively. Every county in Maryland saw incomes rise. 
...
**Answer**  We could ask, "What are the top 5 and 5 lowest performing high schools in terms of their graduates enrolling in college? What is the annual median household income in each school's zip code? Is there a correlation that emerges between income and college enrollment? Are there any outlying schools that buck the trend?" 

What might be harder to interpret I think is data for schools where the students don't necessarilly live in that area. I have no idea how high school enrollment works in Maryland or Baltimore specifically. But where I'm from in Chicago, kids kind of apply to schools almost like applying to college. And they may be able to attend school far from their neighborhood, especially if it's a public "magnet" school. So I would want to know more about how many Baltimore students go to high school in their neighborhoods before I start drawing correlations between the census data from the school's zip code and how students perform. 
...
**Answer** There are 50 high schools in Maryland where over 60% of high school graduates immediately enroll in college; the average annual household income in those schools' zip codes is approximately $111,000. There are 76 Maryland high schoolswhere less than 40% of high school graduates immediately enroll in college; the average annual houshold income in those school's zip codes is approximately $69,000.
...
**Answer** What zip code has the highest concentration of high schools and what is the median household income there? Can we observe a correlation between wealth and things like the number of high schools, or the size of those high schools? I wonder if bigger schools tend to be located in less affluent areas, and whether the size of the school is related to the number of students who immediately enroll in college. 
