...
**Answer** They do not. The 2022 data set has a column name "Total" instead of "TOTAL" like 2016, 2018 and 2020 do. 
...
**Answer** There is a more than 13,500 vote jump in unaffiliated voters from 2016 to 2022. 
...
**Answer** There are 24 rows, but there are 23 counties in Maryland. But on closer look, Baltimore City is included in this dataset as a county even though it isn't technically a county. Apparently the Census considers it as a "county equivalent" - https://www.census.gov/geographies/reference-files/2010/geo/state-local-geo-guides-2010/maryland.html#:~:text=Counties,also%20considered%20a%20county%20equivalent.  
...
**Answer** This data gives each county's population a demographic profile, including the number of adults, white people, Black people, Native American, Asian, and other race designations. 
...
**Answer** Prince George's County is 60.9% Black, and 77% of the population there votes Democratic. PG is both the most Black and the most Democratic voting county in Maryland. 
...
**Answer** Howard County has the highest 18+ Asian population, as 19.4% of the total population. 52.6% of voters in Howard County are Democrats. There is a weaker correlation here between race and party than in the previous example of black & democratic voters in PG County. 
...
**Answer** The ZCTA5N column is a number, or dbl. 
...
**Answer** Now ZCTA5N is a character datatype. 
