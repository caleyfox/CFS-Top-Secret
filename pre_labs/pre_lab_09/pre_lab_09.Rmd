...
https://www.datawrapper.de/_/nR3IL/
...
Before, the map was the entire US in light grey with only the small area of Maryland in color. After toggling on "hide regions without data," now we're looking at just Maryland counties in color and closer up. 
...
Now instead of showing the FIPS code when you hover over a county, you see the full county name. Under the county name it also displays a more concise figure for the percentage of votes that went to Wes Moore, with only one decimal point. 
...
https://www.datawrapper.de/_/mcZ4T/