...
**Answer** The releases dataframe has 999 rows containing information on press releases from Senator Cardin's office, including the date, title, url and text. 
...
**Task** Run the following code and describe what the `unique` function does to the original list of words. **Answer** Unique() has produced a case-sensitive list of words in the a_list_of_words dataframe. 
...
**Answer** We have a dataframe with basically a giant list of the over 647 thousand unique words appearing in the releases dataframe. 
...
**Answer** This graphic of the top words in Cardin's press release is not exactly thrilling. The top words are common articles and pronouns. 
...
**Answer** This is much more interesting. Health being the top word is fascinating, actually. I'd love to know more about whether he was advocating for a healthcare bill perhaps or what was going on in his district during this time. 
...
**Answer** Now we have the top 10 words for 2021, 2022 and 2023. 2021 has covid and 19 in the top ten, so now I'm realizing why it makes sense that health is a top word. The pandemic was obviously raging that whole year. Health fell a spot in 2022, and another in 2023. In 2023, fire, rights and women appear. So sad about that fire that destroyed the rights of women. 
...
**Task** Run the following code and describe the results. 
**Answer** These make sense! We see covid 19, Baltimore City, human rights, public health and more. 
...
**Task** Run the following code and describe the results. 
**Answer** Some of the top 10 two-word phrases in 2022 were project location (interesting!) and several locations in Maryland. It appears like maybe in 2022 the news from the Senator got more local again. 
...
**Task** Run the following code and describe the results. 
**Answer** Even more interesting! Oral health, offshore wind, rights amendment. The guy just loves flossing. 
...
**Answer** Protect is an interesting one, I think it can be very subjective. Protecting abortion rights may create a very negative sentiment for a lot of folks. Protecting gun rights may be positive for others. 
