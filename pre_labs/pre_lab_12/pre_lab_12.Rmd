...
**Answer** Now we have a Date and a Press Releases column. The problem is, Date is a <chr> when it should be a <date>. 
...
**Answer** Don't we probably also want the body text of the releases at some point? So that we can search for terms perhaps that may not appear in the title. I'm not totally sure if that's what you're asking. 
...
**Answer** There are multiple lists. 
...
**Answer** We've removed the html code around the li tags, leaving only the text remaining. 
...
**Task** Run the following code in the gray-colored codeblock below to make a dataframe. Describe the output: **Answer** We've dropped 22 rows, now are working with 100 rows that are only the listing elements and not the links to social media etc. that we don't need. 
