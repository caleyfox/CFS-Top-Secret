...
**Process** Group by year to see change over time. Summarize the number of reported crimes in the major categories of rape, murder, robbery, aggravated assault, breaking and entering, larceny theft and motor vehicle theft. Create a line graph showing these crime trends over time. 

Okay here I got stuck because I didn't know how to visualize multiple variables in a line graph. I tried adding a second y= command but that absolutely didn't work. I figured that there's probably a function I don't know that will help me here so I asked ChatGPT: 
...
**Answer** It looks like rape and murder have maintained relatively stable over the past 4 decades, while aggravated assault and robbery both peaked sharply around 1993-2003 and have since fallen. Why would that be? 
...
```{r}
# Let's make a map. Which counties in MD had the biggest increase in 
```
...
```{r}
# Meeting w/ Derek: go to county police department and see if I can add in last couple years of Uniform Crime Reports - combine the last couple years to see if things are steady or we should be concerned 

# Refine what i have - is there a county outlier in a particular category. 

# Compare PG county and Baltimore City (same % black residents) or another 

#Look at censusreporter.org 

# Is it similar to other part of the state? Make a Maryland grand total colum and figure plot against PG & Baltimore. Could be either a line graph or bar charts. Line charts (19.1 thescoop.org/sports)
